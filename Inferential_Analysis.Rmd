...
3. For the populations to be independent, 60 objects would have to be used so each combination of dose level and delivery method were not affected by the other methods. In research the researchers must have been unaware of which objects were given which dose level or delivery method during measurements. And objects unaware of any specific treatment given to them, if any.
